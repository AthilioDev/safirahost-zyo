        ...
        >
          ...
          <div className="border border-[#1a1a1a] bg-[#080808]">
            ...
            <div className="border-b border-[#111] px-8 py-6">
              <p className="text-[10px] uppercase tracking-widest text-[#f97316] mb-1">Acesso</p>
              <h1 className="text-2xl font-black uppercase tracking-tight">Bem-vindo de volta</h1>
              <p className="text-xs text-[#444] font-mono mt-1">Entre na sua conta Safira</p>
            </div>
